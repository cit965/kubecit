...
var file_helloworld_v1_greeter_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x32, 0x8b, 0x03, 0x0a, 0x07, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x12,
	...
	0x73, 0x42, 0x51, 0x0a, 0x1c, 0x64, 0x65, 0x76, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e,
...
var file_helloworld_v1_greeter_proto_depIdxs = []int32{
	...
	8, // 6: helloworld.v1.Greeter.SayHello:output_type -> helloworld.v1.HelloReply
	6, // 7: helloworld.v1.Greeter.UserRegister:output_type -> helloworld.v1.UserRegisterResponse
	2, // 8: helloworld.v1.Greeter.UserList:output_type -> helloworld.v1.UserListResponse
	4, // 9: helloworld.v1.Greeter.ClusterList:output_type -> helloworld.v1.ClusterListResponse
